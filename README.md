# Smart Workout Tracker: NotebookLM Edition

iOS-приложение для отслеживания тренировок, которое работает в плотной связке с NotebookLM. Это удобный и абсолютно бесплатный инструмент, созданный для того, чтобы превратить текстовые рекомендации нейросети в реальный тренировочный процесс с последующим анализом.
