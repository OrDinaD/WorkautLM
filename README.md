<table>
  <tr>
    ...
    <td valign="top">
      <h1>AI Workout (AiWorkaut) 🏋️‍♂️</h1>
      <p>
        <strong>AI Workout</strong> — это современное приложение для отслеживания тренировок на iOS, разработанное для тех, кто использует искусственный интеллект для составления программ тренировок. Оно ориентировано на удобство ввода данных, визуализацию прогресса и полную автоматизацию разбора планов.
      </p>
    </td>
  </tr>
</table>
